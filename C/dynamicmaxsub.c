...
int maxSubArray(const int* A, int n1) {
    ...
    //r =(res *)malloc(sizeof(res));
    
    if(n1<2){                                //if the size of the array is less than 2
...
int main(){
    ...
    int r;// = malloc(sizeof(res));
    
    r = maxSubArray(A,n);
    printf("The max subarray in  the above array is from position %d to %d and value %d",r,r,r);
